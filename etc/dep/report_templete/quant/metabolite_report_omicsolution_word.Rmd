...
include_img(
  png_path = file.path(report_path, "3.QC/2.correlation/NEG/correlation_NEG.png"),
  pdf_path = file.path(report_path, "3.QC/2.correlation/NEG/correlation_NEG.pdf")
)
include_img(
  png_path = file.path(report_path, "3.QC/2.correlation/POS/correlation_POS.png"),
  pdf_path = file.path(report_path, "3.QC/2.correlation/POS/correlation_POS.pdf")
)
...
include_img(
  png_path = file.path(report_path, "3.QC/3.RSD/NEG/RSD_NEG.png")
)
include_img(
  png_path = file.path(report_path, "3.QC/3.RSD/POS/RSD_POS.png")
)
...
include_img(
  png_path = file.path(report_path, "3.QC/4.PCA/NEG/PCA_NEG.png")
)
include_img(
  png_path = file.path(report_path, "3.QC/4.PCA/POS/PCA_POS.png")
)
...
if (nrow(final_summary) > 0 &&
  ...
  cat("## 分组差异结果表\n\n")
  cat(paste0("### ", group.data[1], "\n\n"))
  cat(paste0("* > 正离子表格：`./5.差异筛选/", group.data[1], "/", group.data[1], "_表格拆分与去重.xlsx`\n\n"))
...
if (nrow(final_summary) > 0 &&
  ...
  cat(paste0("### ", group.data[1], "\n\n"))
  msea_xlsx <- file.path(report_path, "8.MSEA", group.data[1], "MSEA_result.xlsx")
  ...
  include_img(
    png_path = file.path(report_path, "8.MSEA", group.data[1], "MSEA_dpi300.png")
  )
  include_img(
    pdf_path = file.path(report_path, "8.MSEA", group.data[1], "Top10Pathways_ES.pdf")
  )
