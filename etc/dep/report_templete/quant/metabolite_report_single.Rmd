...
cat(paste0('* [>打开缺失值过滤数据表](./2.数据预处理/1.缺失值过滤/组内缺失值过滤数据_single.xlsx)\n\n'))
cat(paste0('* [>打开缺失值填充数据表](./2.数据预处理/2.缺失值填充/缺失值填充数据_single.xlsx)\n\n'))
cat(paste0('* [>打开RSD过滤数据表](./2.数据预处理/3.RSD过滤/RSD过滤数据_single.xlsx)\n\n'))
cat(paste0('* [>打开归一化数据表](./2.数据预处理/4.归一化/归一化处理数据_single.xlsx)\n\n'))
cat(" \n\n")
...
if (final_summary$diff_feature[which(final_summary$ion_type=="single")]%>%sum>0 & final_summary$diff_feature_name[which(final_summary$ion_type=="single")]%>%sum>0){
  ...
  for (group_name in group.data) {
    ...
    cat(paste0("### ", group_name, " \n\n"))
    cat(paste0('* [>打开单离子的表格](./5.差异代谢物分析/1.分组对比/',group_name,'/0.差异筛选表格/',group_name,'_组间对比_single.xlsx)\n\n'))
    cat(" \n\n")
