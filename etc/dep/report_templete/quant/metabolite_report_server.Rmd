...
cat(paste0('* [>打开RSD过滤数据表_POS](', url_path, '/2.数据预处理/3.RSD过滤/RSD过滤数据_POS.xlsx)\n\n'))
cat(paste0('* [>打开RSD过滤数据表_NEG](', url_path, '/2.数据预处理/3.RSD过滤/RSD过滤数据_NEG.xlsx)\n\n'))
...
if (final_summary$diff_feature[which(final_summary$ion_type=="POS&NEG")]%>%sum>0 & final_summary$diff_feature_name[which(final_summary$ion_type=="POS&NEG")]%>%sum>0){
  ...
  for (group_name in group.data) {
    ...
    cat(paste0('* [>打开正离子的表格](', url_path, '/5.差异代谢物分析/1.分组对比/',group_name,'/0.差异筛选表格/',group_name,'_组间对比_POS.xlsx)\n\n'))
    cat(paste0('* [>打开负离子的表格](', url_path, '/5.差异代谢物分析/1.分组对比/',group_name,'/0.差异筛选表格/',group_name,'_组间对比_NEG.xlsx)\n\n'))
