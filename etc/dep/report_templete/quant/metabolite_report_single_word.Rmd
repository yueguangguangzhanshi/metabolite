...
include_img(
  png_path = file.path(report_path, "3.QC/2.correlation/correlation_single.png"),
  pdf_path = file.path(report_path, "3.QC/2.correlation/correlation_single.pdf")
)
...
include_img(
  png_path = file.path(report_path, "3.QC/3.RSD/RSD_single.png")
)
...
include_img(
  png_path = file.path(report_path, "3.QC/4.PCA/PCA_single.png")
)
...
include_img(
  png_path = file.path(report_path, "3.QC/5.CV/cv_single.png")
)
...
if (nrow(final_summary) > 0 &&
  ...
  cat("## 分组差异结果表\n\n")
  cat(paste0("### ", group.data[1], "\n\n"))
  cat(paste0("* > 单离子表格：`./5.差异代谢物分析/1.分组对比/", group.data[1], "/0.差异筛选表格/", group.data[1], "_组间对比_single.xlsx`\n\n"))
